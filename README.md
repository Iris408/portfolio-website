...
- Added Technical Log v1.2.0 with filterable engineering notes
- Added notes for AI HR backend testing, frontend CI TypeScript fixes, and Astro build debugging
- Moved technical notes into a reusable data file
- Added category/tag filtering for engineering notes
