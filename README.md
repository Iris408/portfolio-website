...
- Added GitHub Actions CI/CD coverage across Python automation, backend, Docker, and full-stack projects
- Added Live Weather Report and Payment Receipt Generator to the portfolio projects page
- Updated project metadata with CI/CD tags, deployment status, and clearer technical descriptions
- Improved portfolio project filtering with tags for Automation and CI/CD
